/*
 **
 ** pinmux_config.c source file generated on abril 5, 2014 at 11:11:17.	
 **
 ...
 ** EPPI2 (D00, D01, D02, D03, D04, D05, D06, D07, D08, D09, D10, D11, D12, D13, D14, D15, CLK, FS1, FS2)
 **
 ** GPIO (unavailable)
 ** ------------------
 ** PA00, PA01, PA02, PA03, PA04, PA05, PA06, PA07, PA08, PA09, PA10, PA11, PA12,
 ** PA13, PA14, PA15, PB00, PB01, PB02, PE07, PE08, PE09, PF00, PF01, PF02, PF03,
 ** PF04, PF05, PF06, PF07, PF08, PF09, PF10, PF11, PF12, PF13, PF14, PF15
 */
...
#define EPPI2_D08_PORTA_MUX  ((uint32_t) ((uint32_t) 1<<16))
#define EPPI2_D09_PORTA_MUX  ((uint32_t) ((uint32_t) 1<<18))
#define EPPI2_D10_PORTA_MUX  ((uint32_t) ((uint32_t) 1<<20))
#define EPPI2_D11_PORTA_MUX  ((uint32_t) ((uint32_t) 1<<22))
#define EPPI2_D12_PORTA_MUX  ((uint32_t) ((uint32_t) 1<<24))
#define EPPI2_D13_PORTA_MUX  ((uint32_t) ((uint32_t) 1<<26))
#define EPPI2_D14_PORTA_MUX  ((uint32_t) ((uint32_t) 1<<28))
#define EPPI2_D15_PORTA_MUX  ((uint32_t) ((uint32_t) 1<<30))
...
#define EPPI2_D08_PORTA_FER  ((uint32_t) ((uint32_t) 1<<8))
#define EPPI2_D09_PORTA_FER  ((uint32_t) ((uint32_t) 1<<9))
#define EPPI2_D10_PORTA_FER  ((uint32_t) ((uint32_t) 1<<10))
#define EPPI2_D11_PORTA_FER  ((uint32_t) ((uint32_t) 1<<11))
#define EPPI2_D12_PORTA_FER  ((uint32_t) ((uint32_t) 1<<12))
#define EPPI2_D13_PORTA_FER  ((uint32_t) ((uint32_t) 1<<13))
#define EPPI2_D14_PORTA_FER  ((uint32_t) ((uint32_t) 1<<14))
#define EPPI2_D15_PORTA_FER  ((uint32_t) ((uint32_t) 1<<15))
...
int32_t adi_initpinmux(void) {
    ...
    *pREG_PORTA_MUX = EPPI2_D00_PORTA_MUX | EPPI2_D01_PORTA_MUX
     ...
     | EPPI2_D08_PORTA_MUX | EPPI2_D09_PORTA_MUX | EPPI2_D10_PORTA_MUX
     | EPPI2_D11_PORTA_MUX | EPPI2_D12_PORTA_MUX | EPPI2_D13_PORTA_MUX
     | EPPI2_D14_PORTA_MUX | EPPI2_D15_PORTA_MUX;
    ...
    *pREG_PORTA_FER = EPPI2_D00_PORTA_FER | EPPI2_D01_PORTA_FER
     ...
     | EPPI2_D08_PORTA_FER | EPPI2_D09_PORTA_FER | EPPI2_D10_PORTA_FER
     | EPPI2_D11_PORTA_FER | EPPI2_D12_PORTA_FER | EPPI2_D13_PORTA_FER
     | EPPI2_D14_PORTA_FER | EPPI2_D15_PORTA_FER;
