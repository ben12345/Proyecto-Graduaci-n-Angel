/*
** ADSP-BF609 CPLB table definitions for coreA generated on Nov 21, 2012 at 13:37:59.
*/
/*
...
cplb_entry dcplbs_table[] = {
   ...
   */
   ...
   /* 
   ** Configuration for 64 MB SDRAM (DDR2).
   **
   ** This SDRAM memory is split into two, one half for each core, as follows:
   **   Cached shareable       - 8MB (SDRAM_BANK0)
   **   Shareable              - 8MB (SDRAM_BANK1)
   **   Core specific data     - 8MB (SDRAM_BANK2)
   **   Core specific code     - 8MB (SDRAM_BANK3)
   */

   {0x00000000, (ENUM_DCPLB_DATA_4MB | CACHE_MEM_MODE)}, 
   {0x00400000, (ENUM_DCPLB_DATA_4MB | CACHE_MEM_MODE)}, 
   {0x00800000, (ENUM_DCPLB_DATA_4MB | CPLB_DNOCACHE)}, 
   {0x00c00000, (ENUM_DCPLB_DATA_4MB | CPLB_DNOCACHE)}, 
   {0x01000000, (ENUM_DCPLB_DATA_4MB | CACHE_MEM_MODE)}, 
   {0x01400000, (ENUM_DCPLB_DATA_4MB | CACHE_MEM_MODE)}, 
   {0x01800000, (ENUM_DCPLB_DATA_4MB | CACHE_MEM_MODE)}, 
   {0x01c00000, (ENUM_DCPLB_DATA_4MB | CACHE_MEM_MODE)}, 
   {0x02000000, (ENUM_DCPLB_DATA_4MB | CACHE_MEM_MODE)}, 
   {0x02400000, (ENUM_DCPLB_DATA_4MB | CACHE_MEM_MODE)}, 
   {0x02800000, (ENUM_DCPLB_DATA_4MB | CPLB_DNOCACHE)}, 
   {0x02c00000, (ENUM_DCPLB_DATA_4MB | CPLB_DNOCACHE)}, 
   {0x03000000, (ENUM_DCPLB_DATA_4MB | CPLB_READONLY_ACCESS)}, 
   {0x03400000, (ENUM_DCPLB_DATA_4MB | CPLB_READONLY_ACCESS)}, 
   {0x03800000, (ENUM_DCPLB_DATA_4MB | CPLB_READONLY_ACCESS)}, 
   {0x03c00000, (ENUM_DCPLB_DATA_4MB | CPLB_READONLY_ACCESS)}, 
