...
void FINBOARD_I2C_Mux_Disable(void);
void FINBOARD_I2C_Mux_Enable1(void);
void FINBOARD_I2C_Mux_Enable2(void);

//
// LED Drivers Init/Config
//

// init one LED driver (excludes I2C mux configuration)
void FINBOARD_LED_Driver_Init(void);
void FINBOARD_LED_Driver_Config( uint8_t intensity );

// init both LED drivers (includes I2C mux configuration)
